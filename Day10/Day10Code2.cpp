//this code uses simplex theorem
//learn simplex and then try
//or try Z3
...
//         ops[pressed] = jolt
//         patterns[lights].append(pressed)
...
//         total = float('inf')
//         lights = tuple(x % 2 for x in target)
...
// print(p1)
// print(p2)
 //shit broke me too much i did in python
