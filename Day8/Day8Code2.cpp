...
JunctionBox lastBox1; //init lastbox 1 & 2
JunctionBox lastBox2;
//build the connection unions 
while(UF.getSize(0) != junctionBoxes.size()) //jab tak ek single network na ban jay
...
for(auto& connection : connections){
    ...
    //we just have to multiply X coords of the last two boxes
